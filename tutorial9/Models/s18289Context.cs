...
{
    public partial class s18289Context : DbContext
    {
        public s18289Context()
        {
        }

        public s18289Context(DbContextOptions<s18289Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18289;Integrated Security=True");
            }
        }
